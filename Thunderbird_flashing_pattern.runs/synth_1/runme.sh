...
HD_PWD='C:/temp/Thunderbird_flashing_pattern/Thunderbird_flashing_pattern.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flashing_pattern.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flashing_pattern.tcl
