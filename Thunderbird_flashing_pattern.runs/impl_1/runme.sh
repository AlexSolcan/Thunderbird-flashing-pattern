...
HD_PWD='C:/temp/Thunderbird_flashing_pattern/Thunderbird_flashing_pattern.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flashing_pattern.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flashing_pattern.tcl -notrace
